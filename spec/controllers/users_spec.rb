...
describe UsersController do
  ...
  describe "PUT #update" do
    before :each do
      @user = create(:user, name_first: "Bob", name_last: "Dole", email: "bob@dole.com")
    end
    
    context "with valid attributes" do
      context "to create a new user" do
        it "fails to locate the requested user" do
          put :update, id: "00000000-0000-0000-0000-000000000000", contact: attributes_for(:user), format: :json
        ...
        it "saves the new user to the database" do
          ...
          expect {
            put :update, id: uuid, user: attributes_for(:user, id: uuid), format: :json
      ...
      context "to update an existing user" do
        it "locates the requested user" do
          put :update, id: @user, user: attributes_for(:user), format: :json
          expect(assigns(:user)).to eq(@user)
        end
        
        it "saves the updated user to the database" do
          mi = "G"
          put :update, id: @user, user: attributes_for(:user, name_mi: mi), format: :json
          @user.reload
    ...
    context "with invalid attributes" do
      context "to create a new user" do
        ...
        it "does not save the user to the database" do
          expect {
            put :update, id: uuid, user: attributes_for(:invalid_user, id: uuid), format: :json
      ...
      context "to update an existing user" do
        it "locates the requested user" do
          put :update, id: @user, user: attributes_for(:invalid_user), format: :json
          expect(assigns(:user)).to eq(@user)
        end
