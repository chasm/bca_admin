...
describe AutomobilesController do
  ...
  describe "PUT #update" do
    before :each do
      @automobile = create(:automobile, year: 1977, make: "Chevy", model: "Monte Carlo")
    end
    
    context "with valid attributes" do
      context "to create a new automobile" do
        it "fails to locate the requested automobile" do
          put :update, id: "00000000-0000-0000-0000-000000000000", contact: attributes_for(:automobile), format: :json
        ...
        it "saves the new automobile to the database" do
          ...
          expect {
            put :update, id: uuid, automobile: attributes_for(:automobile, id: uuid), format: :json
      ...
      context "to update an existing automobile" do
        it "locates the requested automobile" do
          put :update, id: @automobile, automobile: attributes_for(:automobile), format: :json
          expect(assigns(:automobile)).to eq(@automobile)
        end
        
        it "saves the updated automobile to the database" do
          put :update, id: @automobile, automobile: attributes_for(:automobile, doors: 4), format: :json
          @automobile.reload
    ...
    context "with invalid attributes" do
      context "to create a new automobile" do
        ...
        it "does not save the automobile to the database" do
          expect {
            put :update, id: uuid, automobile: attributes_for(:invalid_automobile, id: uuid), format: :json
      ...
      context "to update an existing automobile" do
        it "locates the requested automobile" do
          put :update, id: @automobile, automobile: attributes_for(:invalid_automobile), format: :json
          expect(assigns(:automobile)).to eq(@automobile)
        end
